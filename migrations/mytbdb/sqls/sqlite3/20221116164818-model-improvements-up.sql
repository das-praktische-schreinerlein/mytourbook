...
-- improve model
-- ----------------
ALTER TABLE location RENAME COLUMN l_calced_subtype to DELETED_l_calced_subtype;
ALTER TABLE location ADD COLUMN l_calced_subtype VARCHAR(50) GENERATED ALWAYS AS ("loc_" || l_typ) VIRTUAL;

ALTER TABLE poi ADD COLUMN poi_type int(11) DEFAULT '0';
ALTER TABLE poi ADD COLUMN poi_calced_subtype VARCHAR(50) GENERATED ALWAYS AS ("poi_" || poi_type) VIRTUAL;
ALTER TABLE poi ADD COLUMN l_id int(11) DEFAULT NULL REFERENCES location (l_id);

ALTER TABLE tour ADD COLUMN t_datefirst date DEFAULT NULL;
ALTER TABLE tour ADD COLUMN t_datelast date DEFAULT NULL;
UPDATE tour set t_datefirst=t_datevon where t_datefirst is null;
UPDATE tour set t_datelast=t_datebis where t_datelast is null;
--ALTER TABLE tour RENAME COLUMN t_datevon TO DELETED_t_datefirst;
--ALTER TABLE tour RENAME COLUMN t_datebis TO DELETED_t_datelast;

ALTER TABLE location ADD COLUMN l_datefirst date DEFAULT NULL;
ALTER TABLE location ADD COLUMN l_datelast date DEFAULT NULL;

ALTER TABLE poi ADD COLUMN poi_datefirst date DEFAULT NULL;
ALTER TABLE poi ADD COLUMN poi_datelast date DEFAULT NULL;
...
FROM (
         ...
         SELECT "ROUTE"                                                           AS type,
                 ...
                 DATETIME(t_DATEFIRST)                   AS dateonly,
                 CAST(STRFTIME("%W", t_DATEFIRST) AS INT)                           AS week,
                 CAST(STRFTIME("%m", t_DATEFIRST) AS INT)                           AS month,
                 CAST(STRFTIME("%Y", t_DATEFIRST) AS INT)                           AS year,
