...
# add playlists
############# */
ALTER TABLE image_playlist ADD COLUMN ip_details varchar(1000) DEFAULT NULL;
ALTER TABLE video_playlist ADD COLUMN vp_details varchar(1000) DEFAULT NULL;
...
FROM (
         SELECT "IMAGE"                               AS type,
                "IMAGE" || "_" || image_playlist.i_id AS id,
         ...
         UNION
         SELECT "VIDEO"                               AS type,
                "VIDEO" || "_" || video_playlist.v_id AS id,
         ...
         UNION
         SELECT "ROUTE"                                  AS type,
                "ROUTE" || "_" ||  tour_playlist.t_id AS id,
         ...
         UNION
         SELECT "TRACK"                                       AS type,
                "TRACK" || "_" ||  kategorie_playlist.k_id AS id,
         ...
         UNION
         SELECT "TRIP"                                   AS type,
                "TRIP" || "_" ||  trip_playlist.tr_id AS id,
         ...
         UNION
         SELECT "INFO"                                   AS type,
                "INFO" || "_" ||  info_playlist.if_id AS id,
         ...
         UNION
         SELECT "LOCATION"                                      AS type,
                "LOCATION" || "_" ||  location_playlist.l_id AS id,
