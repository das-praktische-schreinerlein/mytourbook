...
-- improve model
-- ----------------
ALTER TABLE location DROP COLUMN l_calced_subtype;
ALTER TABLE location ADD COLUMN l_calced_subtype VARCHAR(50) GENERATED ALWAYS AS (CONCAT("loc_", l_typ)) STORED;

ALTER TABLE poi ADD COLUMN IF NOT EXISTS poi_type int(11) DEFAULT '0';
ALTER TABLE poi ADD COLUMN IF NOT EXISTS poi_calced_subtype VARCHAR(50) GENERATED ALWAYS AS (CONCAT("poi_", poi_type)) STORED;
ALTER TABLE poi ADD COLUMN IF NOT EXISTS l_id int(11) DEFAULT NULL;
ALTER TABLE poi ADD CONSTRAINT poi_ibfk_l FOREIGN KEY (l_id) REFERENCES location (l_id);

ALTER TABLE tour CHANGE IF EXISTS t_datevon t_datefirst DATETIME NULL;
ALTER TABLE tour CHANGE IF EXISTS t_datebis t_datelast DATETIME NULL;

ALTER TABLE location ADD COLUMN IF NOT EXISTS l_datefirst DATETIME DEFAULT NULL;
ALTER TABLE location ADD COLUMN IF NOT EXISTS l_datelast DATETIME DEFAULT NULL;

ALTER TABLE poi ADD COLUMN IF NOT EXISTS poi_datefirst DATETIME DEFAULT NULL;
ALTER TABLE poi ADD COLUMN IF NOT EXISTS poi_datelast DATETIME DEFAULT NULL;
