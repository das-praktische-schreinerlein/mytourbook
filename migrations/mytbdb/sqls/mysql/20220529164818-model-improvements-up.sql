...
FROM (
         (SELECT "IMAGE"                                                                     AS type,
                 ...
                 CONCAT(COALESCE(i_meta_name, ""), " ", k_name, " ", l_lochirarchietxt)      AS html,
         ...
         (SELECT "VIDEO"                                                                     AS type,
                 ...
                 CONCAT(COALESCE(v_meta_name, ""), " ", k_name, " ", l_lochirarchietxt)      AS html,
         ...
         (SELECT "TRACK"                                                                     AS type,
                 ...
                 kategorie.l_id,
                 k_name                                                                      AS meta_name,
                 CONCAT(k_name, " ", COALESCE(k_meta_shortdesc, ""), " ", l_name, " ", l_lochirarchietxt)            AS html,
         ...
         (SELECT "ROUTE"                                                          AS type,
                 ...
                 tour.l_id,
                 t_name                                                           AS meta_name,
                 CONCAT(t_name, " ", COALESCE(t_meta_shortdesc, ""), " ", l_lochirarchietxt) AS html,
         ...
         (SELECT "TRIP"                                                                        AS type,
                 ...
                 CONCAT(tr_name, " ", COALESCE(tr_meta_shortdesc, ""), " ", l_lochirarchietxt) AS html,
         ...
         (SELECT "INFO"                                                             AS type,
                 ...
                 CONCAT(if_name, " ", COALESCE(if_meta_shortdesc, " "), l_lochirarchietxt) AS html,
                 NULL                                                               as blocked,
                 NULL                                                               as date,
                 NULL                                                               as datevon,
                 NULL                                                               as datebis,
         ...
         (SELECT "LOCATION"                                                              AS type,
                 ...
                 location.l_id,
                 l_name                                                                  AS meta_name,
                 CONCAT(l_name, " ", COALESCE(l_meta_shortdesc, ""), " ", l_lochirarchietxt) AS html,
