...
where
    image_keyword.kw_id = doubletteKeywords.old_kw_id
    AND image_keyword.kw_id in
      (
...
CREATE TEMPORARY TABLE IF NOT EXISTS tmp_image_keyword AS
    SELECT * FROM image_keyword where true = false;
