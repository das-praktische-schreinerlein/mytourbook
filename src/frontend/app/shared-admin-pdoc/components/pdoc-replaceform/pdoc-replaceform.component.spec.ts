...
import {PDocReplaceFormComponent} from './pdoc-replaceform.component';
...
describe('PDocReplaceFormComponent', () => {
    let component: PDocReplaceFormComponent;
    let fixture: ComponentFixture<PDocReplaceFormComponent>;

    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [PDocReplaceFormComponent],
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(PDocReplaceFormComponent);
