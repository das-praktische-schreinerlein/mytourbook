...
export class SqlMytbDbLocationConfig {
    public static readonly tableConfig: TableConfig = {
        ...
        selectFieldList: [
            ...
            'location.l_name',
            'location.l_datefirst AS t_dateshow',
        ...
        sortMapping: {
            ...
            'date': 'l_datefirst DESC, lh.l_lochirarchietxt ASC, location.l_name ASC',
            'dateAsc': 'l_datefirst ASC, lh.l_lochirarchietxt ASC, location.l_name ASC',
